 ...
 **/
@Controller
@RequestMapping(value = "/admin/compressed")
public class CompressedController {
    ...
    @ResponseBody
    public TableResultVO imageList(Map<String,Object> map, String compressed){
        List<MyFile> imageList = myFileService.list(new QueryWrapper<MyFile>().lambda()
                .eq(MyFile::getType, 3).like(MyFile::getMyFileName,compressed));
